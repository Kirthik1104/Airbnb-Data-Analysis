...
print("TOP 3 Private room with minimum price, 300+ days availability,price less than 100 and maximum number of review is available at:")
...
print("TOP 3 Entire home/apt with minimum price, 300+ days availability, price less than 100 and maximum number of review is available at:")
for i in my_variable:
    x = i.get('availability_365')
    y = x / 365
    percentage = round(y * 100, 2)
...
print("TOP 3 Shared room with minimum price, 300+ days availability,price less than 100 and maximum number of review is available at:")
for i in my_variable:
    x = i.get('availability_365')
    y = x / 365
    percentage = round(y * 100, 2)
