...
#Top 5 popular location
print("\n")
print("Popular Airbnb locations to visit under high rated host and total night spent by touristnote:")
query=[
  {"$group" :
  {
          "_id" : "$neighbourhood",
...
#Top 2 popular host name under given location
